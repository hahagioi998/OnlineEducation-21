...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map createNative(String orderNo) {
        try{
            ...
            //redisTemplate.opsForValue().set(orderNo, map, 120, TimeUnit.MINUTES);             return map;
            return map;
        }catch (Exception e){
    ...
    public Map<String, String> getPayStatus(String orderNo) {
        try{
            ...
            HttpClient client = new
                    HttpClient("https://api.mch.weixin.qq.com/pay/orderquery");             client.setXmlParam(WXPayUtil.generateSignedXml(m,
